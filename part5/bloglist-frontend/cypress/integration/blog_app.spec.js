describe('Blog app', function() {
  ...
  describe('When logged in', function() {
    ...
    describe('When several blogs are created they are sorted by likes', function () {
      beforeEach(function () {
        cy.createBlog({ title: 'Blog 1', author: 'Author 1', url: 'www.url1.com', likes: 1 })
        ...
        cy.createBlog({ title: 'Blog 4', author: 'Author 4', url: 'www.url4.com' })
      })

      it('in order of most likes to least likes', function () {
